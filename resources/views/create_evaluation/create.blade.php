...
<body class="bg-gray-100 text-gray-900">
    <div class="container mx-auto px-4 py-6">
        ...
        <h2 class="text-2xl font-bold mb-6 mt-8">Crear Nuevo Indicador</h2>

        <form action="{{ route('create_new_evaluation') }}" method="GET" class="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
            @csrf
            <div class="mb-4">
                <label for="description" class="block text-lg font-medium mb-2">Descripción:</label>
                <textarea id="description" name="description" cols="30" rows="4" maxlength="1000" class="w-full px-3 py-2 bg-gray-100 text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
            </div>
            <div class="mb-4">
                <label for="category_id" class="block text-lg font-medium mb-2">Categoría:</label>
                <select id="category_id" name="category_id" class="w-full px-3 py-2 bg-gray-100 text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
