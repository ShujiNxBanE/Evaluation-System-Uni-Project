...
<body class="bg-gray-100 text-gray-900">
            ...
            <div class="relative flex items-center justify-between h-12">
                ...
                <div class="flex-shrink-0">
                    <button type="button"
                        ...
                        class="text-gray-900 px-3 py-1 rounded-md text-sm sm:text-base font-medium bg-gray-300 hover:bg-gray-400 transition duration-200 flex items-center">
                ...
                <div class="flex-shrink-0 flex items-center space-x-2 sm:space-x-3 pr-2">
                    ...
                    <form id="logout-form" action="{{ route('logoutUser') }}" method="POST">
                        @csrf
                        <button type="submit" class="bg-gray-300 hover:bg-gray-400 text-gray-900 text-xs py-1 px-2 sm:text-sm sm:py-1 sm:px-2 rounded-md transition duration-200">
                            Cerrar Sesión
                        </button>
                    </form>
                </div>
    ...
    <div class="max-w-full mx-auto mt-4 px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <header class="bg-gray-300 text-gray-900 text-center py-3 rounded-md mb-4">
            <h1 class="text-xl sm:text-2xl font-semibold">Gestor de Archivos</h1>
        </header>

        <!-- Category and Evaluation Description -->
        <div class="bg-gray-300 p-4 rounded-lg shadow-md mb-8">
        ...
        <!-- File List -->
        <header class="bg-gray-300 text-gray-900 text-center py-2 rounded-md mb-4">
                ...
                <tbody>
                    @foreach ($evidences as $evidence)
                        <tr class="border-b border-black">
                            ...
                            <td class="px-4 py-2">
                                <a href="{{ route('download', ['filename' => $evidence->file_url]) }}" class="text-blue-800 hover:text-blue-600" download>Descargar</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
