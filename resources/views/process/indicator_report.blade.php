...
<body class="bg-gray-900 text-white min-h-screen flex flex-col justify-center">
    ...
    <div class="container mx-auto p-4 max-w-4xl bg-gray-800 text-white rounded-lg shadow-lg my-8">
        <div class="mb-4">
        ...
        <form action="{{ route('process_create_new_report', ['program' => $program->id, 'category' => $category->id, 'evaluation' => $evaluation->id]) }}" method="GET">
                        ...
                        <tr>
                            <td class="py-2 px-4 bg-gray-800">
                                <label class="block">
                                    ...
                                    <span class="ml-6 text-gray-400">El administrador no observa ningún indicador de la norma de calidad evaluada.</span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="py-2 px-4 bg-gray-800">
                                <label class="block">
                                    ...
                                    <span class="ml-6 text-gray-400">El administrador ha identificado una mínima presencia de la norma de calidad evaluada. Esta área todavía necesita muchas mejoras.</span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="py-2 px-4 bg-gray-800">
                                <label class="block">
                                    ...
                                    <span class="ml-6 text-gray-400">El administrador ha identificado una implementación moderada de la norma de calidad. Esta área todavía necesita ciertas mejoras.</span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="py-2 px-4 bg-gray-800">
                                <label class="block">
                                    ...
                                    <span class="ml-6 text-gray-400">El administrador ha determinado que la norma de calidad se está implementando satisfactoriamente y no hay necesidad de mejora en esta área.</span>
                                </label>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="mt-4">
                ...
                <textarea id="comments" name="comments" rows="4" class="w-full p-2 bg-gray-800 text-white rounded-md border border-gray-600" placeholder="Escribe tus comentarios aquí..." maxlength="500">{{ isset($report) ? $report->comments : '' }}</textarea>
            </div>

            <div class="mt-4">
                <label for="suggestions" class="block mb-2">Sugerencias:</label>
                <textarea id="suggestions" name="suggestions" rows="4" class="w-full p-2 bg-gray-800 text-white rounded-md border border-gray-600" placeholder="Escribe tus sugerencias aquí..." maxlength="500">{{ isset($report) ? $report->suggestions : '' }}</textarea>
            </div>

            <div class="flex justify-center mt-6">
                <button type="submit" class="py-2 px-4 bg-blue-900 hover:bg-blue-800 rounded-md border border-white">Guardar</button>
            </div>
        </form>
    </div>
</body>
